...
usage()
{
	...
	echo "master ... cp master files on 1014"
	echo "mod ... cp mod files on 1014"
	echo "mod2 ... cp mod2 files on 1014"
...
do_cp CMakeLists.txt	CMakeLists.txt.1014	CMakeLists.txt.1014mod
# n:-1 llama.cpp/CMakeLists.txt.1014
# n:1 llama.cpp/Makefile
do_cp Makefile	Makefile.1014	Makefile.1014mod
# n:-1 llama.cpp/Makefile.1014
# n:1 llama.cpp/ggml.h
do_cp ggml.h	ggml.h.1014	ggml.h.1014mod
# n:-1 llama.cpp/ggml.h.1014
# n:1 llama.cpp/ggml.c
do_cp ggml.c	ggml.c.1014	ggml.c.1014mod
# n:-1 llama.cpp/ggml.c.1014
# n:1 llama.cpp/ggml-opencl.h
do_cp ggml-opencl.h	ggml-opencl.h.0616	ggml-opencl.h.1014mod
# n:1 llama.cpp/ggml-opencl.h.0616
# llama.cpp/ggml-opencl.h.0616 skip cp
# n:1 llama.cpp/ggml-opencl.cpp
do_cp ggml-opencl.cpp	ggml-opencl.cpp.1014	ggml-opencl.cpp.1014mod
# n:-1 llama.cpp/ggml-opencl.cpp.1014
# n:1 llama.cpp/ggml-alloc.h
do_cp ggml-alloc.h	ggml-alloc.h.1014	ggml-alloc.h.1014mod
# n:-1 llama.cpp/ggml-alloc.h.1014
# n:1 llama.cpp/ggml-alloc.c
do_cp ggml-alloc.c	ggml-alloc.c.1014	ggml-alloc.c.1014mod
# n:-1 llama.cpp/ggml-alloc.c.1014
# n:1 llama.cpp/k_quants.h
do_cp k_quants.h	k_quants.h.1014	k_quants.h.1014mod
# n:-1 llama.cpp/k_quants.h.1014
# n:1 llama.cpp/k_quants.c
do_cp k_quants.c	k_quants.c.1014	k_quants.c.1014mod
# n:-1 llama.cpp/k_quants.c.1014
# n:1 llama.cpp/llama.h
do_cp llama.h	llama.h.1014	llama.h.1014mod
# n:-1 llama.cpp/llama.h.1014
# n:1 llama.cpp/llama.cpp
do_cp llama.cpp	llama.cpp.1014	llama.cpp.1014mod
# n:-1 llama.cpp/llama.cpp.1014
# do_cp llama-util.h	llama-util.h.0811	llama-util.h.0903mod
# n:1 llama.cpp/common/CMakeLists.txt
do_cp common/CMakeLists.txt	common/CMakeLists.txt.1014	common/CMakeLists.txt.1014mod
# n:-1 llama.cpp/common/CMakeLists.txt.1014
# n:1 llama.cpp/common/common.h
do_cp common/common.h	common/common.h.1014	common/common.h.1014mod
# n:-1 llama.cpp/common/common.h.1014
# n:1 llama.cpp/common/common.cpp
do_cp common/common.cpp	common/common.cpp.1014	common/common.cpp.1014mod
# n:-1 llama.cpp/common/common.cpp.1014
# n:1 llama.cpp/common/console.h
do_cp common/console.h	common/console.h.0903	common/console.h.1014mod
# n:1 llama.cpp/common/console.h.0903
# llama.cpp/common/console.h.0903 skip cp
# n:1 llama.cpp/common/console.cpp
do_cp common/console.cpp	common/console.cpp.0930	common/console.cpp.1014mod
# n:1 llama.cpp/common/console.cpp.0930
# llama.cpp/common/console.cpp.0930 skip cp
# n:1 llama.cpp/common/grammar-parser.h
do_cp common/grammar-parser.h	common/grammar-parser.h.0903	common/grammar-parser.h.1014mod
...
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.0930	common/grammar-parser.cpp.1014mod
# n:1 llama.cpp/common/grammar-parser.cpp.0930
# llama.cpp/common/grammar-parser.cpp.0930 skip cp
# n:1 llama.cpp/common/log.h
do_cp common/log.h	common/log.h.0930	common/log.h.1014mod
# n:1 llama.cpp/common/log.h.0930
# llama.cpp/common/log.h.0930 skip cp
# n:1 llama.cpp/examples/CMakeLists.txt
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.1014	examples/CMakeLists.txt.1014mod
# n:-1 llama.cpp/examples/CMakeLists.txt.1014
...
do_cp examples/main/main.cpp	examples/main/main.cpp.1014	examples/main/main.cpp.1014mod
# n:-1 llama.cpp/examples/main/main.cpp.1014
# n:1 llama.cpp/examples/benchmark/benchmark-matmult.cpp
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.0930	examples/benchmark/benchmark-matmult.cpp.1014mod
...
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.1014	tests/CMakeLists.txt.1014mod
# n:-1 llama.cpp/tests/CMakeLists.txt.1014
...
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.0930	tests/test-quantize-fns.cpp.1014mod
...
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.1014	tests/test-quantize-perf.cpp.1014mod
# n:-1 llama.cpp/tests/test-quantize-perf.cpp.1014
# n:1 llama.cpp/tests/test-grad0.cpp
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.1014	tests/test-grad0.cpp.1014mod
# n:-1 llama.cpp/tests/test-grad0.cpp.1014
# n:1 llama.cpp/tests/test-opt.cpp
do_cp tests/test-opt.cpp	tests/test-opt.cpp.1014	tests/test-opt.cpp.1014mod
# n:-1 llama.cpp/tests/test-opt.cpp.1014
# n:1 llama.cpp/tests/test-sampling.cpp
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.0930	tests/test-sampling.cpp.1014mod
...
do_cp tests/test-tokenizer-0-llama.cpp	tests/test-tokenizer-0-llama.cpp.1014	tests/test-tokenizer-0-llama.cpp.1014mod
# n:-1 llama.cpp/tests/test-tokenizer-0-llama.cpp.1014
# n:1 llama.cpp/tests/test-tokenizer-0-falcon.cpp
do_cp tests/test-tokenizer-0-falcon.cpp	tests/test-tokenizer-0-falcon.cpp.1014	tests/test-tokenizer-0-falcon.cpp.1014mod
# n:-1 llama.cpp/tests/test-tokenizer-0-falcon.cpp.1014
# n:1 llama.cpp/tests/test-llama-grammar.cpp
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.0903	tests/test-llama-grammar.cpp.1014mod
...
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.0903	tests/test-grammar-parser.cpp.1014mod
...
do_cp tests/test-c.c	tests/test-c.c.0903	tests/test-c.c.1014mod
