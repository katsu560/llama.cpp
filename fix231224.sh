...
usage()
{
	...
	echo "  master ... cp master files on 231224"
	echo "  mod ... cp mod files on 231224"
	echo "  mod2 ... cp mod2 files on 231224"
...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.231224	CMakeLists.txt.231224mod
do_cp Makefile	Makefile.231224	Makefile.231224mod
do_cp ggml.h	ggml.h.231224	ggml.h.231224mod
do_cp ggml.c	ggml.c.231224	ggml.c.231224mod
do_cp ggml-opencl.h	ggml-opencl.h.230616	ggml-opencl.h.231224mod
do_cp ggml-opencl.cpp	ggml-opencl.cpp.231217	ggml-opencl.cpp.231224mod
do_cp ggml-alloc.h	ggml-alloc.h.231217	ggml-alloc.h.231224mod
do_cp ggml-alloc.c	ggml-alloc.c.231224	ggml-alloc.c.231224mod
do_cp llama.h	llama.h.231224	llama.h.231224mod
do_cp llama.cpp	llama.cpp.231224	llama.cpp.231224mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.231217	common/CMakeLists.txt.231224mod
do_cp common/common.h	common/common.h.231224	common/common.h.231224mod
do_cp common/common.cpp	common/common.cpp.231224	common/common.cpp.231224mod
do_cp common/console.h	common/console.h.230903	common/console.h.231224mod
do_cp common/console.cpp	common/console.cpp.230930	common/console.cpp.231224mod
do_cp common/grammar-parser.h	common/grammar-parser.h.230903	common/grammar-parser.h.231224mod
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.231217	common/grammar-parser.cpp.231224mod
do_cp common/log.h	common/log.h.231217	common/log.h.231224mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.231224	examples/CMakeLists.txt.231224mod
do_cp examples/main/main.cpp	examples/main/main.cpp.231217	examples/main/main.cpp.231224mod
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.231217	examples/benchmark/benchmark-matmult.cpp.231224mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.231217	tests/CMakeLists.txt.231224mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.231217	tests/test-quantize-fns.cpp.231224mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.231217	tests/test-quantize-perf.cpp.231224mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.231224	tests/test-grad0.cpp.231224mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.231217	tests/test-opt.cpp.231224mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.231217	tests/test-sampling.cpp.231224mod
do_cp tests/test-tokenizer-0-llama.cpp	tests/test-tokenizer-0-llama.cpp.231014	tests/test-tokenizer-0-llama.cpp.231224mod
do_cp tests/test-tokenizer-0-falcon.cpp	tests/test-tokenizer-0-falcon.cpp.231014	tests/test-tokenizer-0-falcon.cpp.231224mod
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.230903	tests/test-llama-grammar.cpp.231224mod
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.230903	tests/test-grammar-parser.cpp.231224mod
do_cp tests/test-c.c	tests/test-c.c.230903	tests/test-c.c.231224mod
msg "RESULT: $RESULT"
