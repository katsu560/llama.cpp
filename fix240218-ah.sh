...
do_mk()
{
	msg "making new $NAMEBASE script $NAMEBASE$DT1$MYEXT.sh and copy backup files ..."
...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.240218	CMakeLists.txt.240218mod
do_cp Makefile	Makefile.240218	Makefile.240218mod
do_cp ggml.h	ggml.h.240218	ggml.h.240218mod
do_cp ggml.c	ggml.c.240218	ggml.c.240218mod
do_cp ggml-opencl.h	ggml-opencl.h.240128	ggml-opencl.h.240218mod
do_cp ggml-opencl.cpp	ggml-opencl.cpp.240210	ggml-opencl.cpp.240218mod
do_cp ggml-alloc.h	ggml-alloc.h.240218	ggml-alloc.h.240218mod
do_cp ggml-alloc.c	ggml-alloc.c.240218	ggml-alloc.c.240218mod
do_cp llama.h	llama.h.240218	llama.h.240218mod
do_cp llama.cpp	llama.cpp.240218	llama.cpp.240218mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.240128	common/CMakeLists.txt.240218mod
do_cp common/common.h	common/common.h.240218	common/common.h.240218mod
do_cp common/common.cpp	common/common.cpp.240218	common/common.cpp.240218mod
do_cp common/console.h	common/console.h.240128	common/console.h.240218mod
do_cp common/console.cpp	common/console.cpp.240128	common/console.cpp.240218mod
do_cp common/grammar-parser.h	common/grammar-parser.h.240128	common/grammar-parser.h.240218mod
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.240128	common/grammar-parser.cpp.240218mod
do_cp common/log.h	common/log.h.240128	common/log.h.240218mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240218	examples/CMakeLists.txt.240218mod
do_cp examples/main/main.cpp	examples/main/main.cpp.240218	examples/main/main.cpp.240218mod
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.240128	examples/benchmark/benchmark-matmult.cpp.240218mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240128	tests/CMakeLists.txt.240218mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.240218	tests/test-quantize-fns.cpp.240218mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.240218	tests/test-quantize-perf.cpp.240218mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240128	tests/test-grad0.cpp.240218mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.240128	tests/test-opt.cpp.240218mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.240210	tests/test-sampling.cpp.240218mod
do_cp tests/test-tokenizer-0-llama.cpp	tests/test-tokenizer-0-llama.cpp.240218	tests/test-tokenizer-0-llama.cpp.240218mod
do_cp tests/test-tokenizer-0-falcon.cpp	tests/test-tokenizer-0-falcon.cpp.240218	tests/test-tokenizer-0-falcon.cpp.240218mod
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.240210	tests/test-llama-grammar.cpp.240218mod
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.240128	tests/test-grammar-parser.cpp.240218mod
do_cp tests/test-c.c	tests/test-c.c.240210	tests/test-c.c.240218mod
msg "RESULT: $RESULT"
