...
usage()
{
	...
	echo "  master ... cp master files on 240107"
	echo "  mod ... cp mod files on 240107"
	echo "  mod2 ... cp mod2 files on 240107"
...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.240107	CMakeLists.txt.240107mod
do_cp Makefile	Makefile.240102	Makefile.240107mod
# llama.cpp/Makefile.240102 skip cp
do_cp ggml.h	ggml.h.240102	ggml.h.240107mod
# llama.cpp/ggml.h.240102 skip cp
do_cp ggml.c	ggml.c.240107	ggml.c.240107mod
do_cp ggml-opencl.h	ggml-opencl.h.240102	ggml-opencl.h.240107mod
# llama.cpp/ggml-opencl.h.240102 skip cp
do_cp ggml-opencl.cpp	ggml-opencl.cpp.231224	ggml-opencl.cpp.240107mod
do_cp ggml-alloc.h	ggml-alloc.h.231224	ggml-alloc.h.240107mod
do_cp ggml-alloc.c	ggml-alloc.c.231224	ggml-alloc.c.240107mod
do_cp llama.h	llama.h.240107	llama.h.240107mod
# llama.cpp/llama.h.231224 skip cp
do_cp llama.cpp	llama.cpp.240107	llama.cpp.240107mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.240102	common/CMakeLists.txt.240107mod
# llama.cpp/common/CMakeLists.txt.240102 skip cp
do_cp common/common.h	common/common.h.231224	common/common.h.240107mod
# llama.cpp/common/common.h.231224 skip cp
# llama.cpp/common/common.h.231224 skip cp
do_cp common/common.cpp	common/common.cpp.240102	common/common.cpp.240107mod
# llama.cpp/common/common.cpp.240102 skip cp
do_cp common/console.h	common/console.h.230903	common/console.h.240107mod
# llama.cpp/common/console.h.230903 skip cp
# llama.cpp/common/console.h.230903 skip cp
do_cp common/console.cpp	common/console.cpp.230930	common/console.cpp.240107mod
# llama.cpp/common/console.cpp.230930 skip cp
# llama.cpp/common/console.cpp.230930 skip cp
do_cp common/grammar-parser.h	common/grammar-parser.h.230903	common/grammar-parser.h.240107mod
# llama.cpp/common/grammar-parser.h.230903 skip cp
# llama.cpp/common/grammar-parser.h.230903 skip cp
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.231224	common/grammar-parser.cpp.240107mod
do_cp common/log.h	common/log.h.231224	common/log.h.240107mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.231224	examples/CMakeLists.txt.240107mod
# llama.cpp/examples/CMakeLists.txt.231224 skip cp
# llama.cpp/examples/CMakeLists.txt.231224 skip cp
do_cp examples/main/main.cpp	examples/main/main.cpp.231224	examples/main/main.cpp.240107mod
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.231224	examples/benchmark/benchmark-matmult.cpp.240107mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240102	tests/CMakeLists.txt.240107mod
# llama.cpp/tests/CMakeLists.txt.240102 skip cp
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.231224	tests/test-quantize-fns.cpp.240107mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.231224	tests/test-quantize-perf.cpp.240107mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240102	tests/test-grad0.cpp.240107mod
# llama.cpp/tests/test-grad0.cpp.240102 skip cp
do_cp tests/test-opt.cpp	tests/test-opt.cpp.231224	tests/test-opt.cpp.240107mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.231224	tests/test-sampling.cpp.240107mod
do_cp tests/test-tokenizer-0-llama.cpp	tests/test-tokenizer-0-llama.cpp.231014	tests/test-tokenizer-0-llama.cpp.240107mod
# llama.cpp/tests/test-tokenizer-0-llama.cpp.231014 skip cp
# llama.cpp/tests/test-tokenizer-0-llama.cpp.231014 skip cp
do_cp tests/test-tokenizer-0-falcon.cpp	tests/test-tokenizer-0-falcon.cpp.231014	tests/test-tokenizer-0-falcon.cpp.240107mod
# llama.cpp/tests/test-tokenizer-0-falcon.cpp.231014 skip cp
# llama.cpp/tests/test-tokenizer-0-falcon.cpp.231014 skip cp
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.230903	tests/test-llama-grammar.cpp.240107mod
# llama.cpp/tests/test-llama-grammar.cpp.230903 skip cp
# llama.cpp/tests/test-llama-grammar.cpp.230903 skip cp
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.230903	tests/test-grammar-parser.cpp.240107mod
# llama.cpp/tests/test-grammar-parser.cpp.230903 skip cp
# llama.cpp/tests/test-grammar-parser.cpp.230903 skip cp
do_cp tests/test-c.c	tests/test-c.c.230903	tests/test-c.c.240107mod
