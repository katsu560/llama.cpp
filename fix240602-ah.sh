...
do_cp ggml-opencl.h	ggml-opencl.h.240128	ggml-opencl.h.240602mod
do_cp ggml-opencl.cpp	ggml-opencl.cpp.240602	ggml-opencl.cpp.240602mod
do_cp ggml-alloc.h	ggml-alloc.h.240330	ggml-alloc.h.240602mod
do_cp ggml-alloc.c	ggml-alloc.c.240427	ggml-alloc.c.240602mod
do_cp llama.h	llama.h.240602	llama.h.240602mod
do_cp llama.cpp	llama.cpp.240602	llama.cpp.240602mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.240427	common/CMakeLists.txt.240602mod
do_cp common/common.h	common/common.h.240602	common/common.h.240602mod
do_cp common/common.cpp	common/common.cpp.240602	common/common.cpp.240602mod
do_cp common/console.h	common/console.h.240128	common/console.h.240602mod
do_cp common/console.cpp	common/console.cpp.240128	common/console.cpp.240602mod
do_cp common/grammar-parser.h	common/grammar-parser.h.240128	common/grammar-parser.h.240602mod
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.240520	common/grammar-parser.cpp.240602mod
do_cp common/log.h	common/log.h.240520	common/log.h.240602mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240520	examples/CMakeLists.txt.240602mod
do_cp examples/main/main.cpp	examples/main/main.cpp.240602	examples/main/main.cpp.240602mod
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.240330	examples/benchmark/benchmark-matmult.cpp.240602mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240602	tests/CMakeLists.txt.240602mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.240407	tests/test-quantize-fns.cpp.240602mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.240218	tests/test-quantize-perf.cpp.240602mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240602	tests/test-grad0.cpp.240602mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.240309	tests/test-opt.cpp.240602mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.240210	tests/test-sampling.cpp.240602mod
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.240224	tests/test-llama-grammar.cpp.240602mod
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.240224	tests/test-grammar-parser.cpp.240602mod
do_cp tests/test-c.c	tests/test-c.c.240210	tests/test-c.c.240602mod
msg "RESULT: $RESULT"
