...
do_cp ggml-alloc.c	ggml-alloc.c.240224	ggml-alloc.c.240224mod
do_cp llama.h	llama.h.240224	llama.h.240224mod
do_cp llama.cpp	llama.cpp.240224	llama.cpp.240224mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.240128	common/CMakeLists.txt.240224mod
do_cp common/common.h	common/common.h.240218	common/common.h.240224mod
do_cp common/common.cpp	common/common.cpp.240224	common/common.cpp.240224mod
...
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.240128	examples/benchmark/benchmark-matmult.cpp.240224mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240224	tests/CMakeLists.txt.240224mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.240218	tests/test-quantize-fns.cpp.240224mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.240218	tests/test-quantize-perf.cpp.240224mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240128	tests/test-grad0.cpp.240224mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.240128	tests/test-opt.cpp.240224mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.240210	tests/test-sampling.cpp.240224mod
do_cp tests/test-tokenizer-0-llama.cpp	tests/test-tokenizer-0-llama.cpp.240218	tests/test-tokenizer-0-llama.cpp.240224mod
do_cp tests/test-tokenizer-0-falcon.cpp	tests/test-tokenizer-0-falcon.cpp.240218	tests/test-tokenizer-0-falcon.cpp.240224mod
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.240224	tests/test-llama-grammar.cpp.240224mod
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.240224	tests/test-grammar-parser.cpp.240224mod
do_cp tests/test-c.c	tests/test-c.c.240210	tests/test-c.c.240224mod
msg "RESULT: $RESULT"
