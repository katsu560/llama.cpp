...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.240804	CMakeLists.txt.240804mod
do_cp Makefile	Makefile.240804	Makefile.240804mod
do_cp common/CMakeLists.txt	common/CMakeLists.txt.240720	common/CMakeLists.txt.240804mod
do_cp common/common.h	common/common.h.240804	common/common.h.240804mod
do_cp common/common.cpp	common/common.cpp.240804	common/common.cpp.240804mod
do_cp common/console.h	common/console.h.240128	common/console.h.240804mod
do_cp common/console.cpp	common/console.cpp.240128	common/console.cpp.240804mod
do_cp common/grammar-parser.h	common/grammar-parser.h.240128	common/grammar-parser.h.240804mod
do_cp common/grammar-parser.cpp	common/grammar-parser.cpp.240626	common/grammar-parser.cpp.240804mod
do_cp common/log.h	common/log.h.240720	common/log.h.240804mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240804	examples/CMakeLists.txt.240804mod
do_cp examples/main/main.cpp	examples/main/main.cpp.240804	examples/main/main.cpp.240804mod
do_cp examples/benchmark/benchmark-matmult.cpp	examples/benchmark/benchmark-matmult.cpp.240330	examples/benchmark/benchmark-matmult.cpp.240804mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240804	tests/CMakeLists.txt.240804mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.240720	tests/test-quantize-fns.cpp.240804mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.240720	tests/test-quantize-perf.cpp.240804mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240626	tests/test-grad0.cpp.240804mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.240309	tests/test-opt.cpp.240804mod
do_cp tests/test-sampling.cpp	tests/test-sampling.cpp.240804	tests/test-sampling.cpp.240804mod
do_cp tests/test-llama-grammar.cpp	tests/test-llama-grammar.cpp.240804	tests/test-llama-grammar.cpp.240804mod
do_cp tests/test-grammar-parser.cpp	tests/test-grammar-parser.cpp.240626	tests/test-grammar-parser.cpp.240804mod
do_cp tests/test-c.c	tests/test-c.c.240210	tests/test-c.c.240804mod
msg "RESULT: $RESULT"
